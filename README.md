...
| [`docs/teacher-demo-video.md`](docs/teacher-demo-video.md) | §9.4、§9.6 | 老师在线示范 `-demo`、教学视频抽帧与判读 `cmd/video` |
...
| [`docs/plan-yoyastar.md`](docs/plan-yoyastar.md) | §12.11~§12.16 | YoYa Star 实战：结算页拒输入、五个判据标定、**广告色块致假判负的事故复盘**、跑批口径、离线设计验证矩阵 |
